...
def go(args):
    ...
    logger.info(f"Current run with 'random_forest.max_features': {rf_config['max_features']}")
    ...
    logger.info(f"Preparing sklearn pipeline with 'max_tfidf_features': {args.max_tfidf_features}")
    ...
    artifact = wandb.Artifact(
            ...
            metadata={'random_forest_configartion': rf_config}
        )
